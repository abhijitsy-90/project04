...
const redisClient = redis.createClient(
  13219,                                         //port no 
  "redis-13219.c264.ap-south-1-1.ec2.cloud.redislabs.com",   //end point
  { no_ready_check: true }   //multitasking 
);
redisClient.auth("uVRaAgcJvl5Wtrv3ZklTM29ZtRyYpnmE", function (err) {       //password -performing authentication
  if (err) throw err;   
});

redisClient.on("connect", async function () {       //connceting to cache memoray
...
// });
///connecting setup for radis   using set and get 
